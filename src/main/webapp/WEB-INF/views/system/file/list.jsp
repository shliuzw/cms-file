...
<link rel="stylesheet" href="${jypath}/static/apidoc/JYUI/assets/css/jquery.gritter.css" />

<link rel="stylesheet" href="${jypath}/static/apidoc/JYUI/assets/css/colorbox.css" />
...
<script src="${jypath}/static/js/system/file/file.js"></script>
...
<script src="${jypath}/static/apidoc/JYUI/assets/js/jquery.gritter.min.js"></script>
...
<div class="page-content">
	<div class="row-fluid">
		<div class="col-xs-12">
			...
			<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
				...
				<div class="row">
					<div class="widget-main">
						<input name="beginTime" style="width:140px" value="" class="date-picker" type="text" placeholder="录入开始时间" >至
						<input name="endTime" style="width:140px" value="" class="date-picker" type="text" placeholder="录入结束时间" >
						<input type="text" name="fileName" placeholder="输入文件名" class="input-large">&nbsp;&nbsp;
						<input type="text" style="width:140px" name="fileNo" placeholder="输入文号" class="input-large">&nbsp;&nbsp;
						<input type="text" name="description" placeholder="输入备注" class="input-large">&nbsp;&nbsp;
						<!--
						<span id="selectisValid"><select  data-placeholder="状态" name="isValid" class="chosen-select isSelect75"></select></span>&nbsp;&nbsp;
						-->
			...
			<table id="baseTable" class="table table-striped table-bordered table-hover" >
				<thead>
					<tr>
						...
						<th style="width:10%"  class="center hidden-480">录入时间</th>
						<th style="width:5%"  class="center hidden-480">序号</th>
						<th style="width:10%" class="center">文号</th>
						<th style="width:10%" class="center">文件名</th>
						<th style="width:10%" class="center">属性</th>
						<th style="width:8%"  class="center ">所属部门</th>
						<th style="width:5%"  class="center hidden-480">状态</th>
						<th style="width:15%" class="center hidden-480">备注</th>
			...
			<%@include file="formBackup.jsp" %>
			<!-- #moreImg 引入图片上传部分，默认隐藏 -->
            <%@include file="moreImg.jsp" %>
            <!-- #fileImagePreviewID 引入图片上传部分，默认隐藏 -->
