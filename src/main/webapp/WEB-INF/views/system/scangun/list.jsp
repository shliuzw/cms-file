...
<script src="${jypath}/static/js/system/file/scangun.js"></script>
			...
			<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
				...
				<div class="row">
					<div class="widget-main">
						<input type="text" name="gunNo" placeholder="这里输入扫描枪编码"   class="input-large">&nbsp;&nbsp;
			...
			<table id="baseTable" class="table table-striped table-bordered table-hover" >
				<thead>
					<tr>
						...
						<th style="width:10%" class="center">扫描枪编号</th>
