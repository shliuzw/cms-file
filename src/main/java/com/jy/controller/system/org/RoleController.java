...
public class RoleController extends BaseController<Role>{
	...
	@ResponseBody
	public AjaxRes updateOrg(Org org){
		AjaxRes ar=getAjaxRes();	
		if(ar.setNoAuth(doSecurityIntercept(Const.RESOURCES_TYPE_MENU,SECURITY_URL))){	
			try {
