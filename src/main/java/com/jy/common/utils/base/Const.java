...
public class Const {
	 ...
	 * 备份成功
	 */
	public static final String BACKUP_SUCCEED = "备份成功";
	/**
	 * 备份失败
	 */
	public static final String BACKUP_FAIL = "备份失败";

	public static final String BACKUP_FAIL_SRCDIR = "备份目录不存在";

	public static final String BACKUP_FAIL_DESTDIR = "备份目的目录错误";
}
