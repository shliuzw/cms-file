	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
	     ...
	     if (loginAccount != null) {
	    	//组合username,两次迭代，对密码进行加密 
	    	 String pwdEncrypt =CipherUtil.createPwdEncrypt(username,password,loginAccount.getSalt());
	    	 if(loginAccount.getPassword().equals(pwdEncrypt)){
	    		 authenticationInfo = new SimpleAuthenticationInfo(loginAccount.getLoginName(), password, getName());
